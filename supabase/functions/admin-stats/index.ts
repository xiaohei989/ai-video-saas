  ...
  try {
    ...
    const response = {
      ...
      data: {
        ...
        subscription_revenue: parseFloat(baseDashboardStats.subscription_revenue?.toString() || '0'),
        credit_purchase_revenue: parseFloat(baseDashboardStats.credit_purchase_revenue?.toString() || '0'),
        revenue_today: parseFloat(baseDashboardStats.revenue_today?.toString() || '0'),
        subscription_revenue_today: parseFloat(baseDashboardStats.subscription_revenue_today?.toString() || '0'),
        credit_purchase_revenue_today: parseFloat(baseDashboardStats.credit_purchase_revenue_today?.toString() || '0'),
        revenue_this_week: parseFloat(baseDashboardStats.revenue_this_week?.toString() || '0'),
        subscription_revenue_this_week: parseFloat(baseDashboardStats.subscription_revenue_this_week?.toString() || '0'),
        credit_purchase_revenue_this_week: parseFloat(baseDashboardStats.credit_purchase_revenue_this_week?.toString() || '0'),
        revenue_this_month: parseFloat(baseDashboardStats.revenue_this_month?.toString() || '0'),
        subscription_revenue_this_month: parseFloat(baseDashboardStats.subscription_revenue_this_month?.toString() || '0'),
        credit_purchase_revenue_this_month: parseFloat(baseDashboardStats.credit_purchase_revenue_this_month?.toString() || '0'),
