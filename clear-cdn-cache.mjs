...
async function main() {
  ...
  if (args[0] === 'single' && args[1]) {
    ...
    console.log('   node clear-cdn-cache.mjs single <video-id>        # 清除单个文件缓存')
    console.log('   node clear-cdn-cache.mjs batch <id1,id2,id3>     # 批量清除缓存')
    console.log('   node clear-cdn-cache.mjs all                     # 清除所有缩略图缓存')
    console.log('')
    console.log('📋 示例:')
    console.log('   node clear-cdn-cache.mjs single 2786516b-b122-48ef-adae-16a5757dd10e')
  }
}
